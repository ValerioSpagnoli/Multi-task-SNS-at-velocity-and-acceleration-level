function siml = main()
    ...
    level = 'acceleration';
    robot_name = 'KUKA_LBR_IIWA_7_R800'; % Planar4R, KUKA_LBR_IV, KUKA_LBR_IIWA_7_R800
    q_0 = NaN;
    q_dot_0 = NaN;
    q_ddot_0 = NaN;
    simulation_step = NaN;
    ...
    elseif strcmp(robot_name, 'KUKA_LBR_IV') || strcmp(robot_name, 'KUKA_LBR_IIWA_7_R800')
        siml = Simulation_KUKA(level, robot_name, q_0, q_dot_0, q_ddot_0, simulation_step, epsilon);
    end
end