...
m = {length(x_ddot_1),length(x_ddot_2)};

%% Apply SNS multitask algorithm

q_ddot_SNS = SNS_acceleration_multitask_full(m, n, {J_1, J_2}, {J_dot_1, J_dot_2}, {x_ddot_1, x_ddot_2}, bounds, q_0, q_dot_0, simulation_step, false);

fprintf('q_ddot_SNS = ');disp(round(q_ddot_SNS', 3));
