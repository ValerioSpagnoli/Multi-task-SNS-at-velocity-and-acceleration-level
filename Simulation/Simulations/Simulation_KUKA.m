classdef Simulation_KUKA
    ...
    methods
        ...
        % Create square path
        function path = create_square_path(self, n_cycle)
            poly_0 = [[0; -0.1; 0.1], [0; 0.1; 0.1], [0; 0.1; -0.1], [0; -0.1; -0.1]];            
        ...
        function [joints_positions, joints_velocities, ee_positions, ee_velocities, elbow_positions, elbow_velocities, directional_errors] = run_simulation_velocity_level(self)
